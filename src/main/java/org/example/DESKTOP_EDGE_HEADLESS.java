...
public class DESKTOP_EDGE_HEADLESS {
  public static void main(String[] args) {
    try (Playwright playwright = Playwright.create()) {
      ...
      BrowserContext context = browser.newContext(new Browser.NewContextOptions()
          ...
          .setUserAgent(
              "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.20 Safari/537.36 Edg/104.0.5112.20")
